        ...
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          ...
          <nav className="flex lg:w-2/5 flex-wrap items-center text-base md:ml-auto">
            {navigations.map((navigation) => (
              <Link
                to={navigation.path}
                key={navigation.name} // Add key prop here
          ...
          <div className="lg:w-2/5 inline-flex lg:justify-end ml-5 lg:ml-0">
            <Link to={'/cart'} className="inline-flex items-center bg-purple-400 text-white border-0 py-2 px-4 focus:outline-none hover:bg-indigo-700 rounded text-base mt-4 md:mt-0">
              Go to Cart
              <svg
                fill="none"
                stroke="currentColor"
