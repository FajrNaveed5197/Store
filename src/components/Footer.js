          ...
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              ...
              <a className="text-gray-600 hover:text-gray-800" href="mailto:fajrnaveed5197@gmail.com">
                  fajrnaveed5197@gmail.com
            </a>
              </li>
              <li>
              <a className="text-gray-600 hover:text-gray-800" href="https://www.linkedin.com/in/fajr-naveed-675b91239/">
              LinkedIn
              </a>              
              </li>
              <li>
              <a className="text-gray-600 hover:text-gray-800" href="https://instagram.com/fajr_naveed0__0?igshid=OGQ5ZDc2ODk2ZA==">
              Instagram
              </a> 
